...
// =============================================================================
// Spectrograms (design hook stub — out of scope, task 1.6)
// =============================================================================

// renderSpectrograms is the reserved spectrogram slot stub. It returns "" today;
// before/after region samples already live at regions.<kind>.samples.{input,
// filtered,final}, so a future spectrogram embed has a natural home with no new
// plumbing. The 1.7 orchestrator places this slot AFTER renderRegions; an empty
// return means NO Spectrograms heading or content is emitted (the orchestrator
// must skip empty section returns). Implementing spectrograms is out of scope.
func renderSpectrograms(_ *processor.RunRecord) string {
	return ""
}
